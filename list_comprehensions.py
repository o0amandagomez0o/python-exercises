...
vowels = 'a', 'e', 'i', 'o', 'u'
fruits_with_more_than_two_vowels = [fruit.split() if fruit not in vowels else " " for fruit in fruits]
...
five_more = [fruit for fruit in fruits if (len(fruit) > 5)]
five_more
